...
// Optimition 3: Shared Memory Tiling + Thread Tile
                                             ...
                                             const int K)
{
    ...
    __shared__ __align__(16) float As[BLOCK_SIZE * THREAD_TILE_M][BLOCK_SIZE];
...
Average Runtime: 4.898458 ms
Compute Performance: 14.028799 TFLOPS
Memory Bandwidth: 27.399998 GB/s
 */